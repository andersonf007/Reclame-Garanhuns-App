...
public class CustomAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txtData = (TextView) convertView.findViewById(R.id.tv_data);
            viewHolder.txtComentario = (TextView) convertView.findViewById(R.id.tv_comentario);
            result = convertView;
        ...
        viewHolder.txtData.setText(dataModel.data);
        viewHolder.txtComentario.setText(dataModel.comentario);
